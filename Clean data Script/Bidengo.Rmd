...
Due to the length of the frequency table for the state variable, see appendix 5 \@ref(tab:state-table-ACS) for the Frequency table of state distribution in a subset of 2018 ACS survey. We can observe the number of respondents in each state is almost the same with very similar proportions. 
...
The result table \@ref(tab:tablestate) of Vote Outcome Prediction for Trump of the 2020 American Presidential Election by State.
...
4. See Table \@ref(tab:state-table-nationscape) for the frequency table of state distribution in Nationscape survey.
...
5. See Table \@ref(tab:state-table-ACS) for the Frequency table of state distribution in subset of 2018 ACS survey
